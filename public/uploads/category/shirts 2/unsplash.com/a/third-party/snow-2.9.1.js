/*! For license information please see snow-2.9.1.js.LICENSE.txt */ ! function e(t, n, r) {
    function a(i, c) {
        if (!n[i]) {
            if (!t[i]) {
        ...
        n.trackerCore = function(e, t) {
            ...
            return {
                ...
                trackPagePing: function(t, n, r, o, i, s, u, l, d) {
                    ...
                    return f.add("e", "pp"), f.add("url", t), f.add("page", n), f.add("refr", r), f.add("pp_mix", o.toString()), f.add("pp_max", i.toString()), f.add("pp_miy", s.toString()), f.add("pp_may", u.toString()), c(f, l, d)
                },
                ...
                trackEcommerceTransaction: function(t, n, r, o, i, s, u, l, d, f, p) {
                    ...
                    return m.add("e", "tr"), m.add("tr_id", t), m.add("tr_af", n), m.add("tr_tt", r), m.add("tr_tx", o), m.add("tr_sh", i), m.add("tr_ci", s), m.add("tr_st", u), m.add("tr_co", l), m.add("tr_cu", d), c(m, f, p)
                },
                trackEcommerceTransactionItem: function(t, n, r, o, i, s, u, l, d) {
                    var f = a.payloadBuilder(e);
                    return f.add("e", "ti"), f.add("ti_id", t), f.add("ti_sk", n), f.add("ti_nm", r), f.add("ti_ca", o), f.add("ti_pr", i), f.add("ti_qu", s), f.add("ti_cu", u), c(f, l, d)
                },
    ...
    12: [function(e, t, n) {
        ...
        m.v1 = function(e, t, n) {
            var r = t && n || 0,
                ...
                p = i - d + (s - f) / 1e4;
            if (p < 0 && void 0 === e.clockseq && (o = o + 1 & 16383), (p < 0 || i > d) && void 0 === e.nsecs && (s = 0), s >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
            d = i, f = s, l = o;
                    ...
                    r.forEach(document.getElementsByTagName("form"), (function(t) {
                        c(t) && !t[i] && (r.forEach(o, (function(n) {
                            r.forEach(t.getElementsByTagName(n), (function(t) {
                                s(t) && !t[i] && "password" !== t.type.toLowerCase() && (a.addEventListener(t, "change", d(e), !1), t[i] = !0)
                            }))
                        })), a.addEventListener(t, "submit", f(e)), t[i] = !0)
                    }))
                }
            }
        }
            ...
            (void 0 !== n ? n : this).InQueueManager = function(e, n, a, o, i) {
                ...
                function f() {
                    ...
                    for (e = 0; e < arguments.length; e += 1)
                        ...
                        else if (r = (i = d(o))[0], f = i[1], "newTracker" !== r)
                        if ("setCollectorCf" !== r && "setCollectorUrl" !== r || f && 0 !== f.length)
                            for (p = s(f), n = 0; n < p.length; n++) p[n][r].apply(p[n], a);
                        else u(r, a[0], a[1]);
                    else l(a[0], a[1], a[2])
                }
                for (var p = 0; p < o.length; p++) f(o[p]);
                return {
                    push: f
                }
            }
    ...
    17: [function(e, t, n) {
        ! function() {
            ...
            i.hasSessionStorage = function() {
                ...
                s.constructor === window.Navigator && "unknown" != typeof s.javaEnabled && !t.isUndefined(s.javaEnabled) && s.javaEnabled() && (l.java = "1"), t.isFunction(c.GearsFactory) && (l.gears = "1"), l.res = u.width + "x" + u.height, l.cd = u.colorDepth, e && (l.cookie = i.hasCookies(n));
                var d = {
                    update: function() {
                        if ("undefined" != typeof window && "function" == typeof window.addEventListener) {
                            var e = !1,
                                ...
                                n = function() {};
                            window.addEventListener("testPassiveEventSupport", n, t), window.removeEventListener("testPassiveEventSupport", n, t), d.hasSupport = e
                        }
                    }
                };
                return d.update(), !0 === d.hasSupport && (l.passive = "1"), l.wheel = "onwheel" in document.createElement("div") ? "wheel" : void 0 !== document.onmousewheel ? "mousewheel" : "DOMMouseScroll", l
            }
        }()
    }, {
        "../lib_managed/lodash": 20,
        ...
        (function(e) {
            (function() {
                var r, a = "[object Arguments]",
                    ...
                    N = {};
                N[w] = N[y] = N[k] = N[A] = N[b] = N[S] = N[T] = N[C] = N[E] = !0, N[a] = N[o] = N[v] = N[i] = N[c] = N[s] = N[u] = N[l] = N[d] = N[f] = N[p] = N[m] = N[g] = N[h] = !1;
                var U = {};
                U[a] = U[o] = U[v] = U[i] = U[c] = U[w] = U[y] = U[k] = U[A] = U[b] = U[d] = U[f] = U[p] = U[g] = U[S] = U[T] = U[C] = U[E] = !0, U[s] = U[u] = U[l] = U[m] = U[h] = !1;
                var F = {
                        function: !0,
                        object: !0
                    },
                ...
                var J = Array.prototype,
                    ...
                    ce = 9007199254740991,
                    se = {};
                se[w] = H.Float32Array, se[y] = H.Float64Array, se[k] = H.Int8Array, se[A] = H.Int16Array, se[b] = H.Int32Array, se[S] = ae, se[T] = H.Uint8ClampedArray, se[C] = H.Uint16Array, se[E] = H.Uint32Array;
                var ue = {};
                    ...
                    return "function" == a ? t === r ? e : Pe(e, t, n) : null == e ? ct : "object" == a ? _e(e) : t === r ? ut(e) : function(e, t) {
                        ...
                        return e = Ve(e),
                            function(i) {
                                if (null == i) return !1;
                                var c = o;
                                if (i = qe(i), (n || !a) && !(c in i)) {
                                    if (i = 1 == e.length ? i : Te(i, function(e, t, n) {
                                            var a = -1,
                                                o = e.length;
                ...
                function ve(e, t, n, o, s, l, m) {
                    var h;
                    if (n && (h = s ? n(e, o, s) : n(e)), h !== r) return h;
                    if (!Xe(e)) return e;
                    var _ = Ke(e);
                    if (_) {
                        if (h = function(e) {
                        ...
                        var I = Z.call(e),
                            P = I == u;
                        if (I != f && I != a && (!P || s)) return U[I] ? function(e, t, n) {
                            var r = e.constructor;
                            switch (t) {
                                case v:
                                    return xe(e);
                    ...
                    for (var x = l.length; x--;)
                        if (l[x] == e) return m[x];
                    return l.push(e), m.push(h), (_ ? fe : Se)(e, (function(r, a) {
                    ...
                    de.enumErrorProps = ne.call(Q, "message") || ne.call(Q, "name"), de.enumPrototypes = ne.call(t, "prototype"), de.nonEnumShadows = !/valueOf/.test(r), de.spliceObjects = (re.call(n, 0, 1), !n[0]), de.unindexedChars = "x" [0] + Object("x")[0] != "xx"
                }();
                ...
                function Te(e, t, n) {
                    if (null != e) {
                        e = qe(e), n !== r && n in e && (t = [n]);
                        for (var a = 0, o = t.length; null != e && a < o;) e = qe(e)[t[a++]];
                        return a && a == o ? e : r
                    }
                }
                ...
                function Ce(e, t, n, r, u, l) {
                    return e === t || (null == e || null == t || !Xe(e) && !G(t) ? e != e && t != t : function(e, t, n, r, u, l, m) {
                        ...
                        var k = w == f && !W(e),
                            A = y == f && !W(t),
                            b = w == y;
                        if (b && !h && !k) return function(e, t, n) {
                            switch (n) {
                                case i:
                                case c:
                                    return +e == +t;
                        ...
                        return function(e, t, n) {
                            ...
                            for (; ++a < o;) {
                                var s = (c = t[a])[0],
                                    ...
                                    l = c[1];
                                if (i && c[2]) {
                                    if (u === r && !(s in e)) return !1
                                } else {
                                    var d = n ? n(u, l, s) : r;
                                    if (!(d === r ? Ce(l, u, n, !0) : d)) return !1
                                }
                            }
                            return !0
                        }(e, t)
                ...
                function je(e, t, n, a, o, i, c) {
                    ...
                    for (; ++s < u;) {
                        ...
                        } else if (d !== f && !n(d, f, a, o, i, c)) return !1
                    }
                    return !0
                }
                ...
                function De(e, t, n, a, o, i, c) {
                    var s = nt(e),
                        u = s.length;
                    if (u != nt(t).length && !o) return !1;
                    for (var l = u; l--;) {
                        var d = s[l];
                        if (!(o ? d in t : X.call(t, d))) return !1
                    }
                    for (var f = o; ++l < u;) {
                        var p = e[d = s[l]],
                            m = t[d],
                            g = a ? a(o ? m : p, o ? p : m, d) : r;
                        if (!(g === r ? n(p, m, a, o, i, c) : g)) return !1;
                        f || (f = "constructor" == d)
                    }
                    if (!f) {
                        var h = e.constructor,
                            v = t.constructor;
                        if (h != v && "constructor" in e && "constructor" in t && !("function" == typeof h && h instanceof h && "function" == typeof v && v instanceof v)) return !1
                    }
                    return !0
                }
                ...
                function rt(e) {
                    ...
                    for (var r = e.constructor, a = -1, o = $e(r) && r.prototype || Y, i = o === e, c = Array(t), u = t > 0, l = n.enumErrorProps && (e === Q || e instanceof Error), d = n.enumPrototypes && $e(e); ++a < t;) c[a] = a + "";
                    for (var p in e) d && "prototype" == p || l && ("message" == p || "name" == p) || u && Fe(p, t) || "constructor" == p && (i || !X.call(e, p)) || c.push(p);
                    if (n.nonEnumShadows && e !== Y) {
                        var m = e === K ? g : e === Q ? s : Z.call(e),
                            h = ue[m] || ue[f];
                        for (m == f && (o = Y), t = O.length; t--;) {
                            var v = h[p = O[t]];
                ...
                le.callback = it, le.filter = We, le.forEach = Je, le.keys = nt, le.keysIn = rt, le.map = Qe, le.mapValues = at, le.matches = st, le.pairs = ot, le.property = ut, le.collect = Qe, le.each = Je, le.iteratee = it, le.select = We, le.find = Ge, le.identity = ct, le.isArguments = Ye, le.isArray = Ke, le.isFunction = $e, le.isNative = Ze, le.isObject = Xe, le.isString = et, le.isTypedArray = tt, le.isUndefined = function(e) {
                    return e === r
                }, le.last = He, le.detect = Ge, le.VERSION = "3.10.1", M && B && V && ((B.exports = le)._ = le)
            }).call(this)
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    }, {}],
    21: [function(e, t, n) {
        ...
        (void 0 !== n ? n : this).getLinkTrackingManager = function(e, t, n) {
            ...
            function d(t, o) {
                for (var i, s, u, l, d, f; null !== (i = t.parentNode) && !r.isUndefined(i) && "A" !== (s = t.tagName.toUpperCase()) && "AREA" !== s;) t = i;
                if (!r.isUndefined(t.href)) {
                    var p = t.hostname || a.getHostName(t.href),
                        m = p.toLowerCase(),
                        g = t.href.replace(p, m);
                    new RegExp("^(javascript|vbscript|jscript|mocha|livescript|ecmascript|mailto):", "i").test(g) || (u = t.id, l = a.getCssClasses(t), d = t.target, f = c ? t.innerHTML : null, g = unescape(g), e.trackLinkClick(g, u, l, d, f, n(o)))
                }
            }
            ...
            function f(e) {
                return function(t) {
                    var n, r;
                    n = (t = t || window.event).which || t.button, r = t.target || t.srcElement, "click" === t.type ? r && d(r, e) : "mousedown" === t.type ? 1 !== n && 2 !== n || !r ? u = l = null : (u = n, l = r) : "mouseup" === t.type && (n === u && r === l && d(r, e), u = l = null)
                }
            }

            function p(e) {
                i ? (a.addEventListener(e, "mouseup", f(s), !1), a.addEventListener(e, "mousedown", f(s), !1)) : a.addEventListener(e, "click", f(s), !1)
            }
            return {
    ...
    22: [function(e, t, n) {
        ! function() {
            ...
            (void 0 !== n ? n : this).OutQueueManager = function(e, n, o, i, c, s, u) {
                ...
                function h() {
                    for (; f.length && "string" != typeof f[0] && "object" != typeof f[0];) f.shift();
                    if (f.length < 1) p = !1;
                    else {
                        if (!t.isString(d)) throw "No Snowplow collector configured, cannot track";
                        p = !0;
                        var e = f[0];
                        if (c) {
                            var n = v(d),
                            ...
                            n.onreadystatechange = function() {
                                if (4 === n.readyState && n.status >= 200 && n.status < 400) {
                                    for (var e = 0; e < o; e++) f.shift();
                                    i && a.attemptWriteLocalStorage(l, JSON.stringify(f)), clearTimeout(r), h()
                            ...
                            var m = new Image(1, 1);
                            m.onload = function() {
                                f.shift(), i && a.attemptWriteLocalStorage(l, JSON.stringify(f)), h()
                            }, m.onerror = function() {
                                p = !1
                ...
                return t.isArray(f) || (f = []), o.outQueues.push(f), c && s > 1 && o.bufferFlushers.push((function() {
                    p || h()
                })), {
                    enqueueRequest: function(e, n) {
                        if (d = n + m, c) {
                            ...
                            if (r.bytes >= u) return a.warn("Event of size " + r.bytes + " is too long - the maximum size is " + u), void v(d).send(w(y([r.evt])));
                            f.push(r)
                        } else f.push(function(e) {
                            var t = "?",
                                n = {
                                    co: !0,
                                    cx: !0
                        ...
                        var o = !1;
                        i && (o = a.attemptWriteLocalStorage(l, JSON.stringify(f))), p || o && !(f.length >= s) || h()
                    },
                    executeQueue: h
                }
            }
        ...
        ! function() {
            ...
            (void 0 !== n ? n : this).Snowplow = function(e, n) {
                ...
                return s.Snowplow = {
                    ...
                    c.removeEventListener("DOMContentLoaded", e, !1), d()
                })) : c.attachEvent && (c.attachEvent("onreadystatechange", (function e() {
                    "complete" === c.readyState && (c.detachEvent("onreadystatechange", e), d())
                    ...
                    (l.hasLoaded || /loaded|complete/.test(c.readyState)) && (clearInterval(i), d())
                }), 10)), r.addEventListener(s, "load", d, !1), new a.InQueueManager(o.Tracker, u, l, e, n)
            }
        }()
    }, {
        "./in_queue": 15,
            ...
            (void 0 !== n ? n : this).Tracker = function(e, n, m, g, h) {
                var v, w, y, k, A, b, S, T, C, E, _, I, P, x, j, D, L, O, N, U, F = f(!0, (function(e) {
                        ! function(e) {
                            ...
                            "0" === u ? (O = h, c || "none" == ue || (f++, g = m, O = p.v4()), ve = f) : (new Date).getTime() - ge > 1e3 * ne && (O = p.v4(), ve++);
                            e.add("vp", i.detectViewport()), e.add("ds", i.detectDocumentSize()), e.add("vid", ve), e.add("sid", O), e.add("duid", l), e.add("fp", fe), e.add("uid", N), xe(), e.add("refr", Le(w || H)), e.add("url", Le(k || V)), "none" != ue && (He(l, d, ve, t, g, O), Ve());
                            ge = (new Date).getTime()
                        }(e),
                        function(e, t) {
                            var n = new Date,
                                r = !!o.cookie(C);
                            ee || r || (be.enqueueRequest(e.build(), y), g.expireDateTime = n.getTime() + t)
                        }(e, Q)
                    })),
                    M = document,
                    B = window,
                    z = navigator,
                    R = a.fixupUrl(M.domain, B.location.href, r.getReferrer()),
                    q = r.fixupDomain(R[0]),
                    V = R[1],
                    H = R[2],
                    ...
                    de = i.detectBrowserFeatures("cookie" == ue || "cookieAndLocalStorage" == ue, Ne("testcookie")),
                    fe = !1 === h.userFingerprint ? "" : i.detectSignature(re),
                    pe = e + "_" + n,
                    me = !1,
                    ge = (new Date).getTime(),
                    he = c,
                    ...
                    ye = s.getLinkTrackingManager(F, pe, Qe),
                    ke = u.getFormTrackingManager(F, pe, Qe),
                    Ae = l.errorManager(F),
                    be = new d.OutQueueManager(e, n, g, "localStorage" == ue || "cookieAndLocalStorage" == ue, h.post, h.bufferSize, h.maxPostBytes || 4e4),
                    Se = !1,
                    Te = h.contexts || {},
                    Ce = [],
                    Ee = [],
                    _e = !1,
                    Ie = !1;
                for (var Pe in h.hasOwnProperty("discoverRootDomain") && h.discoverRootDomain && ($ = r.findRootDomain()), Te.gaCookies && Ce.push((U = {}, t.forEach(["__utma", "__utmb", "__utmc", "__utmv", "__utmz", "_ga"], (function(e) {
                        var t = o.cookie(e);
                        t && (U[e] = t)
                    })), {
                        schema: "iglu:com.google.analytics/cookies/jsonschema/1-0-0",
                        data: U
                    })), Te.geolocation && Xe(), F.setBase64Encoding(!h.hasOwnProperty("encodeBase64") || h.encodeBase64), F.setTrackerVersion(m), F.setTrackerNamespace(n), F.setAppId(G), F.setPlatform(W), F.setTimezone(i.detectTimezone()), F.addPayloadPair("lang", le), F.addPayloadPair("cs", ae), de) Object.prototype.hasOwnProperty.call(de, Pe) && ("res" === Pe || "cd" === Pe || "cookie" === Pe ? F.addPayloadPair(Pe, de[Pe]) : F.addPayloadPair("f_" + Pe, de[Pe]));

                function xe() {
                    (R = a.fixupUrl(M.domain, B.location.href, r.getReferrer()))[1] !== V && (H = r.getReferrer(V)), q = r.fixupDomain(R[0]), V = R[1]
                }
                ...
                function Qe(e) {
                    ...
                    if (Te.webPage && n.push({
                        ...
                        var a = function() {
                            ...
                            if (t) {
                                var n = {};
                                for (var a in t.timing) r.isValueInArray(a, e) && null !== t.timing[a] && (n[a] = t.timing[a]);
                            ...
                            var s = function() {
                                ...
                                if (a) {
                                    for (var o = [], i = a.activeExperiments || [], c = 0; c < e.length; c++) {
                                        ...
                                        f[s] && 1 === f[s].length && (u.variationId = f[s][0]), o.push({
                ...
                function et(e, t, n, a) {
                    xe(), Ie && (_e && null != g.pageViewId || (g.pageViewId = p.v4())), Ie = !0, J = M.title, A = e;
                    var o = r.fixupTitle(A || J);
                    F.trackPageView(Le(k || V), o, Le(w || H), Qe(Ze(t, n)), a);
                    var i = new Date;
                    Y && !me && (me = !0, Object.prototype.hasOwnProperty.call(de, "wheel") && (Object.prototype.hasOwnProperty.call(de, "passive") ? r.addEventListener(M, de.wheel, Me, {
                        passive: !0
                    }) : r.addEventListener(M, de.wheel, Me)), Re(), r.addEventListener(M, "click", Me), r.addEventListener(M, "mouseup", Me), r.addEventListener(M, "mousedown", Me), r.addEventListener(M, "mousemove", Me), r.addEventListener(B, "scroll", Be), r.addEventListener(M, "keypress", Me), r.addEventListener(M, "keydown", Me), r.addEventListener(M, "keyup", Me), r.addEventListener(B, "resize", Me), r.addEventListener(B, "focus", Me), r.addEventListener(B, "blur", Me), _ = i.getTime(), clearInterval(v), v = setInterval((function() {
                        var e = new Date;
                        _ + S > e.getTime() && b < e.getTime() && function(e) {
                            xe();
                            var t = M.title;
                            t !== J && (J = t, A = null);
                            F.trackPagePing(Le(k || V), r.fixupTitle(A || J), Le(w || H), qe(I), qe(P), qe(x), qe(j), Qe(e)), Re()
                        }(Ze(t, n))
                    }), S))
                }
                ...
                function rt(e) {
                    ...
                    if (!E)
                        for (n = 0; n < o.length; n++) {
                            ...
                            if (!1 === M[nt(a, "hidden")]) break
                        }
                    t ? r.addEventListener(M, a + "visibilitychange", (function t() {
                        M.removeEventListener(a + "visibilitychange", t, !1), e()
                    })) : e()
                }
                return Fe(),
                    function() {
                        ...
                        setAppId: function(e) {
                            r.warn('setAppId is deprecated. Instead add an "appId" field to the argmap argument of newTracker.'), F.setAppId(e)
                        },
                        ...
                        setCookieDomain: function(e) {
                            r.warn('setCookieDomain is deprecated. Instead add a "cookieDomain" field to the argmap argument of newTracker.'), $ = r.fixupDomain(e), Fe()
                        },
                        ...
                        setUserFingerprintSeed: function(e) {
                            r.warn('setUserFingerprintSeed is deprecated. Instead add a "userFingerprintSeed" field to the argmap argument of newTracker.'), re = e, fe = i.detectSignature(re)
                        },
                        enableUserFingerprint: function(e) {
                            r.warn('enableUserFingerprintSeed is deprecated. Instead add a "userFingerprint" field to the argmap argument of newTracker.'), e || (fe = "")
                        },
                        ...
                        enableActivityTracking: function(e, t) {
                            e === parseInt(e, 10) && t === parseInt(t, 10) ? (Y = !0, b = (new Date).getTime() + 1e3 * e, S = 1e3 * t) : r.warn("Activity tracking not enabled, please provide integer values for minimumVisitLength and heartBeatDelay.")
                        },
                        ...
                        setUserIdFromLocation: function(e) {
                            xe(), N = r.fromQuerystring(e, V)
                        },
                        setUserIdFromReferrer: function(e) {
                            xe(), N = r.fromQuerystring(e, H)
                        },
                        ...
                        setPlatform: function(e) {
                            r.warn('setPlatform is deprecated. Instead add a "platform" field to the argmap argument of newTracker.'), F.setPlatform(e)
                        },
                        encodeBase64: function(e) {
                            r.warn('This usage of encodeBase64 is deprecated. Instead add an "encodeBase64" field to the argmap argument of newTracker.'), F.setBase64Encoding(e)
                        },
