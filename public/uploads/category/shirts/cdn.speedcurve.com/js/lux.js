...
LUX = function() {
    ...
    function r(e) {
        n++, e && void 0 !== e.filename && void 0 !== e.message && (-1 !== e.filename.indexOf("/lux.js?") || -1 !== e.message.indexOf("LUX") || n <= 5 && W()) && ((new Image).src = "https://lux.speedcurve.com/error/?v=216&id=" + J() + "&fn=" + encodeURIComponent(e.filename) + "&ln=" + e.lineno + "&cn=" + e.colno + "&msg=" + encodeURIComponent(e.message) + "&l=" + encodeURIComponent(ge()) + (V() ? "&ct=" + V() : ""))
    }
    ...
    if ("function" == typeof PerformanceObserver) {
        ...
        try {
            "function" == typeof PerformanceLongTaskTiming && a.observe({
                type: "longtask",
                buffered: !0
            }), "function" == typeof LargestContentfulPaint && a.observe({
                type: "largest-contentful-paint",
                buffered: !0
            }), "function" == typeof PerformanceElementTiming && a.observe({
                type: "element",
                buffered: !0
            }), "function" == typeof PerformancePaintTiming && a.observe({
                type: "paint",
                buffered: !0
            }), "function" == typeof LayoutShift && a.observe({
                type: "layout-shift",
                buffered: !0
            })
        } catch (e) {
    ...
    pe("Sample rate = " + X + "%. " + (W() ? "This session IS being sampled." : "This session is NOT being sampled. The data will NOT show up in your LUX dashboards. Call LUX.forceSample() and try again."));
    var S, k = void 0 === LUX.auto || LUX.auto,
        M = LUX.ns ? LUX.ns : Date.now ? Date.now() : +new Date,
        B = 0;
    L && L.timing && L.timing.navigationStart ? (M = L.timing.navigationStart, B = LUX.ns ? LUX.ns - M : 0) : (pe("Nav Timing is not supported."), s |= 2);
    ...
    function C(e) {
        S || (S = Math.round(e), N.forEach((function(e) {
    ...
    function I(e) {
        ...
        if (t) {
            ...
            "pointerdown" == e.type ? function(e, t) {
                ...
                function i() {
                    window.removeEventListener("pointerup", n, x), window.removeEventListener("pointercancel", r, x)
                }
                window.addEventListener("pointerup", n, x), window.addEventListener("pointercancel", r, x)
            }(i) : C(i)
        }
    }
    ...
    function H() {
        ...
        var e = "",
            ...
            n = {};
        if (i.length)
            for (var r = _(h), a = r ? r.startTime : 0, o = r ? _(y).startTime : L.timing.loadEventEnd - L.timing.navigationStart, s = 0; s < i.length; s++) {
                var u = i[s];
                if ("longtask" === u.entryType) {
                    ...
                    t[d] || (t[d] = 0, n[d] = ""), t[d] += c, n[d] += "," + Math.round(u.startTime) + "|" + c
                }
            }
    ...
    function z() {
        ...
        if (_(h) && _(y)) {
                ...
                a = function() {
                    if (L && L.timing) {
                        var e, t = L.timing,
                            n = t.navigationStart;
                        if (n) {
                            if (L && L.getEntriesByType && L.getEntriesByType("paint") && L.getEntriesByType("paint").length)
            ...
            e = t + (r.redirectStart ? "rs" + (r.redirectStart - t) : "") + (r.redirectEnd ? "re" + (r.redirectEnd - t) : "") + (r.fetchStart ? "fs" + (r.fetchStart - t) : "") + (r.domainLookupStart ? "ds" + (r.domainLookupStart - t) : "") + (r.domainLookupEnd ? "de" + (r.domainLookupEnd - t) : "") + (r.connectStart ? "cs" + (r.connectStart - t) : "") + (r.secureConnectionStart ? "sc" + (r.secureConnectionStart - t) : "") + (r.connectEnd ? "ce" + (r.connectEnd - t) : "") + (r.requestStart ? "qs" + (r.requestStart - t) : "") + (r.responseStart ? "bs" + (r.responseStart - t) : "") + (r.responseEnd ? "be" + (r.responseEnd - t) : "") + (r.domLoading ? "ol" + (r.domLoading - t) : "") + (r.domInteractive ? "oi" + (r.domInteractive - t) : "") + (r.domContentLoadedEventStart ? "os" + (r.domContentLoadedEventStart - t) : "") + (r.domContentLoadedEventEnd ? "oe" + (r.domContentLoadedEventEnd - t) : "") + (r.domComplete ? "oc" + (r.domComplete - t) : "") + (r.loadEventStart ? "ls" + (r.loadEventStart - t) : "") + (r.loadEventEnd ? "le" + (r.loadEventEnd - t) : "") + (a ? "sr" + a : "") + (o ? "fc" + o : "") + (s ? "lc" + s : "")
        } else if (_(y)) {
            var u;
    ...
    function J() {
        ...
        var e = Y("/js/lux.js");
        return e ? (LUX.customerid = function(e, t) {
            for (var n = e.split("?")[1].split("&"), r = 0, i = n.length; r < i; r++) {
                var a = n[r].split("=");
                if (t === a[0]) return a[1]
            }
            return
        }(e.src, "id"), LUX.customerid) : ""
    }
    ...
    function ee() {
        ...
        if (e && E && W() && !m) {
                    ...
                    if (L && L.getEntriesByName) {
                        ...
                        if (t) {
                            ...
                            if (n && n.length) {
                                ...
                                e = "d" + i + "t" + a + "f" + o + "c" + s + "n" + u + "e" + c + "r" + X + (d ? "x" + d : "") + (B ? "l" + B : "") + "s" + (LUX_t_start - M)
                            }
                        }
                    }
                    return e
            ...
            var f, g, h, w = U + "?v=" + "216&id=" + e + "&sid=" + E + "&uid=" + T + (a ? "&CD=" + a : "") + "&l=" + encodeURIComponent(ge()),
                k = q("script"),
                N = q("style"),
                x = (l ? "" : "&NT=" + z()) + (p ? "&LJS=" + d : "") + "&PS=ns" + function() {
                    for (var e = document.getElementsByTagName("script"), t = 0, n = 0, r = e.length; n < r; n++) e[n].src && t++;
                    return t
                }() + "bs" + G() + (k > -1 ? "is" + k : "") + "ss" + function() {
                    ...
                    for (var e = 0, t = document.getElementsByTagName("link"), n = 0, r = t.length; n < r; n++) {
                        var i = t[n];
                        i.href && "stylesheet" === i.rel && 0 !== i.href.indexOf("data:") && (i.onloadcssdefined || "print" === i.media || "style" === i.as || "function" == typeof i.onload && "all" === i.media || e++)
                    }
                    return e
                }() + (N > -1 ? "ic" + N : "") + "ia" + function() {
                    ...
                    for (var e = document.getElementsByTagName("*"), t = e.length, n = 0; t--;) n += K(e[t]);
                    return Math.round(n / e.length)
                }() + "nd" + document.getElementsByTagName("*").length + "vh" + document.documentElement.clientHeight + "vw" + document.documentElement.clientWidth + "dh" + (f = document, g = f.body, h = f.documentElement, Math.max(g ? g.scrollHeight : 0, g ? g.offsetHeight : 0, h ? h.clientHeight : 0, h ? h.scrollHeight : 0, h ? h.offsetHeight : 0) + "dw") + function(e) {
                    var t = e.body,
                        n = e.documentElement;
                    return Math.max(t ? t.scrollWidth : 0, t ? t.offsetWidth : 0, n ? n.clientWidth : 0, n ? n.scrollWidth : 0, n ? n.offsetWidth : 0)
                }(document) + (Q() ? "ds" + Q() : "") + (V() ? "ct" + V() + "_" : "") + "er" + n + "nt" + (L && L.navigation && void 0 !== L.navigation.type ? L.navigation.type : "") + (navigator.deviceMemory ? "dm" + Math.round(navigator.deviceMemory) : "") + (o ? "&IX=" + o : "") + (S ? "&FID=" + S : "") + (u ? "&CPU=" + u : "") + (s ? "&fl=" + s : "") + (r ? "&ET=" + r : "") + "&HN=" + encodeURIComponent(document.location.hostname) + (!1 !== c ? "&CLS=" + c : ""),
                C = "";
            if (t) {
            ...
            for (var A = b - w.length; C;) {
                ...
                if (C.length <= A) Z = C, C = "";
                    ...
                    var ee = C.lastIndexOf(",", A); - 1 === ee && (ee = C.indexOf(",")), -1 === ee ? (Z = C, C = "") : (Z = C.substring(0, ee), C = C.substring(ee + 1))
                }
                var te = w + "&UT=" + Z;
    ...
    function te() {
        ...
        if (e && E && W() && !v && m) {
            ...
            if (t) {
                var n = F(),
                    r = "?v=216&id=" + e + "&sid=" + E + "&uid=" + T + (n ? "&CD=" + n : "") + "&l=" + encodeURIComponent(ge()) + "&IX=" + t + (S ? "&FID=" + S : "") + "&HN=" + encodeURIComponent(document.location.hostname),
                    i = U + r;
    ...
    function ne() {
        ...
        if (e && E && W() && m) {
            var t = F();
            if (t) {
                var n = "?v=216&id=" + e + "&sid=" + E + "&uid=" + T + "&CD=" + t + "&l=" + encodeURIComponent(ge()) + "&HN=" + encodeURIComponent(document.location.hostname),
                    r = U + n;
    ...
    function re(e) {
        if ("simple" !== LUX.beaconMode) return function(e) {
    ...
    function me(e) {
        var t, n;
        return e ? Number(new Date) + "00000" : Number(new Date) + "" + (t = parseInt(1e5 * Math.random()), ((n = "00000") + t).slice(-n.length))
    }
    ...
    })), k && ("complete" == document.readyState ? ee() : ue("load", (function() {
        setTimeout(ee, 200)
    })), ue("beforeunload", ee), ue("unload", ee), ue("beforeunload", te), ue("unload", te)), de();
    var he = {
        mark: j,
        ...
        init: function() {
            pe("Enter LUX.init()."), d = {}, fe(), de(), l = 0, m = 0, v = 0, p = 0, E = me(), T = le(E), i.splice(0), s = 0, s |= 1, j(h)
        },
        send: ee,
        addData: function(e, t) {
            pe("Enter LUX.addData(), name = " + e + ", value = " + t);
            var n = typeof t;
            "string" !== typeof e || "string" !== n && "number" !== n && "boolean" !== n || (f[e] = t), m && (o && clearTimeout(o), o = setTimeout(ne, 100))
        },
        ...
        doUpdate: function(e, n) {
            if (e && t < e && document.body && !g) {
                ...
                var r = Y("/js/lux.js");
                if (r)
                    if ("function" == typeof fetch) fetch(r.src, {
                        cache: "reload"
                    });
                    else {
                        var i = document.createElement("iframe");
                        i.style.display = "none", i.id = "LUX_update_iframe", i.src = "//cdn.speedcurve.com/luxupdate.php?src=" + encodeURIComponent(r.src) + (n ? "&tw=" + n : ""), document.body.appendChild(i)
                    }
            }
        },
        cmd: function(e) {
