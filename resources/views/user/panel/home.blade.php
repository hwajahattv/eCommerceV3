		...
		<div class="flex-w flex-c-m">
			...
			<div class="size-202 m-lr-auto respon4">
				...
				<div class="block1 wrap-pic-w">
					<img src="{{ asset('img/uploads/category/'.$cat->image) }}" alt="IMG-BANNER">
					<a href="{{url('productsListOfCategory').'/'.$cat->id }}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
					...
					<div class="blog-item">
						...
						<div class="p-t-15">
							...
							<p class="stext-108 cl6">
								This project takes order for the given coffee flavours and generates the total bill for the order.
							</p>
						</div>
					</div>
				</div>
