    ...
    <div class="container">
        <div class="flex-w flex-sb-m p-b-52">
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                ...
                <a class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 filter_link" data-filter="{{ $cat->name }}">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item media {{$product->Category->name}}">
                <!-- Block2 -->
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ asset('img/uploads/product/' . $product->product_image) }}" alt="IMG-PRODUCT">

                        <a href="javascript:void(0)" id="" data-url="{{ route('products.show', $product->id) }}" class="show-modal block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15">
            ...
            <div class="row">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="img/product-detail-01.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img id="productImage" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="img/product-detail-01.jpg">
                                ...
                                <div class="item-slick3" data-thumb="img/product-detail-02.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        ...
                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="img/product-detail-02.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="item-slick3" data-thumb="img/product-detail-03.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="img/product-detail-03.jpg" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="img/product-detail-03.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <input type="hidden" id="productIdHidden" value="" class="productID">
                        <span id="product-price" class="mtext-106 cl2">

                        </span><span class="mtext-106 cl2">/-Rs.</span>
                        ...
                        <p id="product-id" class="stext-102 cl3 p-t-23">
                            Nulla eget sem vitae eros pharetra viverra. Nam vitae luctus ligula. Mauris consequat ornare
                            feugiat.
                        </p>
                        ...
                        <div class="p-t-33">
                            <div class="flex-w flex-r-m p-b-10">
                                ...
                                <div class="size-204 respon6-next">
                                    <div class="rs1-select2 bor8 bg0 d-flex justify-content-center">
                                        <h4 id="product-size" class="mtext-105 cl2 js-name-detail p-b-14">
                                        </h4>
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    ...
                                    <button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 addToCartBtn">
                                        Add to cart
                                    </button>
                                </div>
                            </div>
